...
const filegroupName = "filegroup"

type filegroupLang struct {
	language.BaseLang
...
var (
	_ language.Language         = (*filegroupLang)(nil)
	_ language.LifecycleManager = (*filegroupLang)(nil)
)

func NewLanguage() language.Language {
	return &filegroupLang{}
}

func (*filegroupLang) Name() string { return filegroupName }

func (*filegroupLang) Kinds() map[string]rule.KindInfo {
	return kinds
}
...
func (l *filegroupLang) Before(ctx context.Context) {
	l.Initialized = true
}

func (l *filegroupLang) GenerateRules(args language.GenerateArgs) language.GenerateResult {
	if !l.Initialized {
...
func (l *filegroupLang) DoneGeneratingRules() {
	l.RulesGenerated = true
}

func (l *filegroupLang) Resolve(c *config.Config, ix *resolve.RuleIndex, rc *repo.RemoteCache, r *rule.Rule, imports interface{}, from label.Label) {
	if !l.RulesGenerated {
...
func (l *filegroupLang) AfterResolvingDeps(ctx context.Context) {
	l.DepsResolved = true
}